...
public class UpdateEntity
{
    ...
    public async Task updating_modifies_correct_documents()
    {
        ...
        await _db.SaveAsync(author3);

        await _db.Update<AuthorEntity>()
        ...
        var count = _db.Queryable<AuthorEntity>().Where(a => a.Name == guid && a.Surname == author1.Name).Count();
    ...
    {
        Assert.ThrowsExactly<ArgumentException>(() => _db.Update<AuthorEntity>().Modify(a => a.Age2, 22).ExecuteAsync().GetAwaiter().GetResult());
    }
    ...
    public async Task updating_returns_correct_result()
    {
        ...
        var res = await _db.Update<AuthorEntity>()
                           .Match(a => a.Surname == guid)
                           .Modify(a => a.Name, guid)
                           .Modify(a => a.Surname, author1.Name)
                           .Option(o => o.BypassDocumentValidation = true)
    ...
    public async Task update_by_def_builder_mods_correct_docs()
    {
        ...
        var res = await _db.Find<AuthorEntity>().ManyAsync(a => a.Surname == guid && a.Age == 10);
    ...
    public async Task bulk_update_modifies_correct_documents()
    {
        ...
        await _db.SaveAsync(books);

        var bulk = _db.Update<BookEntity>();
    ...
    public async Task update_with_pipeline_using_template()
    {
        ...
        var res = await _db.Find<AuthorEntity>().OneAsync(author.ID);
    ...
    public async Task update_with_aggregation_pipeline_works()
    {
        ...
        var fullname = (await _db.Find<AuthorEntity>().OneAsync(author.ID))?.FullName;
    ...
    public async Task update_with_template_match()
    {
        ...
        var fullname = (await _db.Find<AuthorEntity>()
                                 .OneAsync(author.ID))?
            .FullName;
    ...
    public async Task update_with_array_filters_using_templates_work()
    {
        ...
        var res = _db.Queryable<BookEntity>()
    ...
    public async Task skip_setting_mod_date_if_user_is_doing_something_with_it()
    {
        ...
        book = await _db.Find<BookEntity>().OneAsync(book.ID);
        Assert.IsLessThan(5, DateTime.UtcNow.Subtract(book!.ModifiedOn).TotalSeconds);
    ...
    public async Task update_with_modifywith_works()
    {
        ...
        await _db.Update<FlowerEntity>()
                 .MatchID(flower.Id)
                 .ModifyWith(flower)
                 .ExecuteAsync();

        var res = await _db.Find<FlowerEntity>().OneAsync(flower.Id);
    ...
    public async Task bulk_update_with_modifywith()
    {
        ...
        var bulkUpdate = _db.Update<BookEntity>();
    ...
    public async Task update_with_modifyexcept_works()
    {
        ...
        Assert.AreEqual("book", res!.Title);
