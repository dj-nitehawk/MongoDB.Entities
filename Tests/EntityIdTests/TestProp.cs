...
public class PropsEntity
{
    ...
    {
        Expression<Func<BookEntity, object?>> exp = x => x.ReviewList[0].Rating;
        var res = exp.FullPath();
        Assert.AreEqual("ReviewList.Rating", res);

        Expression<Func<BookEntity, object?>> exp1 = x => x.ReviewArray[0].Books[0].ReviewArray[0].Books[0].ModifiedOn;
        var res1 = exp1.FullPath();
        Assert.AreEqual("ReviewArray.Books.ReviewArray.Books.ModifiedOn", res1);

        Expression<Func<BookEntity, object?>> exp2 = x => x.ReviewArray[0].Books[0].Price;
        var res2 = exp2.FullPath();
        Assert.AreEqual("ReviewArray.Books.Price", res2);

        Expression<Func<BookEntity, object?>> exp3 = x => x.ReviewArray[0].Books[0].PriceInt;
        var res3 = exp3.FullPath();
        Assert.AreEqual("ReviewArray.Books.PriceInt", res3);

        Expression<Func<BookEntity, object?>> exp4 = x => x.ReviewArray[0].Books[0].PriceLong;
        var res4 = exp4.FullPath();
        Assert.AreEqual("ReviewArray.Books.PriceLong", res4);

        Expression<Func<BookEntity, object?>> exp5 = x => x.ReviewArray[0].Books[0].PriceDbl;
        var res5 = exp5.FullPath();
        Assert.AreEqual("ReviewArray.Books.PriceDbl", res5);

        Expression<Func<BookEntity, object?>> exp6 = x => x.ReviewArray[0].Books[0].PriceFloat;
    ...
    {
        var res1 = Prop.PosFiltered<BookEntity>(b => b.ReviewArray[0].Books[1].MainAuthor.ID);
        Assert.AreEqual("ReviewArray.$[a].Books.$[b].MainAuthor.ID", res1);

        var res2 = Prop.PosFiltered<BookEntity>(b => b.ReviewList[0].Rating);
    ...
    {
        var res1 = Prop.PosAll<BookEntity>(b => b.ReviewArray[0].Rating);
        Assert.AreEqual("ReviewArray.$[].Rating", res1);

        var res2 = Prop.PosAll<BookEntity>(b => b.ReviewList[0].Rating);
    ...
    {
        var res1 = Prop.PosFirst<BookEntity>(b => b.ReviewArray[0].Rating);
        Assert.AreEqual("ReviewArray.$.Rating", res1);

        var res2 = Prop.PosFirst<BookEntity>(b => b.ReviewList[0].Rating);
        Assert.AreEqual("ReviewList.$.Rating", res2);
    }
    ...
    {
        var res = Prop.Elements<BookEntity>(b => b.Tags);
    ...
    {
        var res = Prop.Elements<BookEntity>(0, b => b.Tags);
        Assert.AreEqual("a.Tags", res);

        var res2 = Prop.Elements<BookEntity>(1, b => b.ReviewList[0].Rating);
