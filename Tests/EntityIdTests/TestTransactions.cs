...
public class TransactionsEntity
{
    ...
    public async Task not_commiting_and_aborting_update_transaction_doesnt_modify_docs()
    {
        ...
        var res = await DB.Default.Find<AuthorEntity>().OneAsync(author1.ID);
    ...
    {
        await DB.Default.Index<AuthorEntity>()
    ...
    public async Task bulk_save_entities_transaction_returns_correct_results()
    {
        ...
        var res = await DB.Default.Find<BookEntity>().ManyAsync(b => b.Title.Contains(guid));
        ...
        res = await DB.Default.Find<BookEntity>().ManyAsync(b => b.Title.Contains(guid));
