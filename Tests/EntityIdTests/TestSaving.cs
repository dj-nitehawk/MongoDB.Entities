...
public class SavingEntity
{
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var author1 = new AuthorEntity { Name = guid }; await author1.SaveAsync();
        var author2 = new AuthorEntity { Name = guid }; await author2.SaveAsync();
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var one = new AuthorEntity { Name = "a", Age = 10, Surname = guid }; await one.SaveAsync();
        var two = new AuthorEntity { Name = "b", Age = 20, Surname = guid }; await two.SaveAsync();
        var three = new AuthorEntity { Name = "c", Age = 30, Surname = guid }; await three.SaveAsync();
        var four = new AuthorEntity { Name = "d", Age = 40, Surname = guid }; await four.SaveAsync();
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var author = new AuthorEntity { Name = "a", Age = 10, Age2 = 11, Surname = guid }; await author.SaveAsync();
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var book1 = new BookEntity { Title = guid, Price = 100.123m }; await book1.SaveAsync();
        var book2 = new BookEntity { Title = guid, Price = 100.123m }; await book2.SaveAsync();
