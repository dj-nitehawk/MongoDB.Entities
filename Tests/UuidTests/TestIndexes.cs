...
public class IndexesUuid
{
    ...
    {
        await DBInstance.Instance().DropCollectionAsync<AuthorUuid>();
        ...
        var res = DBInstance.Instance().FluentTextSearch<AuthorUuid>(Search.Full, author1.Surname).ToList();
        Assert.AreEqual(author1.Surname, res[0].Surname);

        var res2 = await DBInstance.Instance().Find<AuthorUuid>()
    ...
    public async Task full_text_search_with_wilcard_text_index_works()
    {
        ...
        var res = await DBInstance.Instance().FluentTextSearch<AuthorUuid>(Search.Full, author1.Surname).ToListAsync();
    ...
    public async Task fuzzy_text_search_with_text_index_works()
    {
        ...
        await dbInstance.Index<BookUuid>()
          .Option(o => o.Background = false)
        ...
        var res = await dbInstance.Find<BookUuid>()
        ...
        await dbInstance.DeleteAsync<BookUuid>(new[] { b1.ID, b2.ID, b3.ID, b4.ID, b5.ID, b6.ID });
    ...
    public async Task sort_by_meta_text_score_dont_retun_the_score()
    {
        ...
        var res = await DBInstance.Instance().Find<GenreUuid>()
    ...
    {
        await DBInstance.Instance().Index<BookUuid>()
