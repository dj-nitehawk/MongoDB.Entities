...
public class UpdateUuid
{
    ...
    public async Task updating_modifies_correct_documents()
    {
        ...
        await DBInstance.Instance().Update<AuthorUuid>()
    ...
    {
        Assert.ThrowsException<ArgumentException>(() => DBInstance.Instance().Update<AuthorUuid>().Modify(a => a.Age2, 22).ExecuteAsync().GetAwaiter().GetResult());
    }
    ...
    public async Task updating_returns_correct_result()
    {
        ...
        var res = await DBInstance.Instance().Update<AuthorUuid>()
          .Match(a => a.Surname == guid)
          .Modify(a => a.Name, guid)
          .Modify(a => a.Surname, author1.Name)
          .Option(o => o.BypassDocumentValidation = true)
    ...
    public async Task update_by_def_builder_mods_correct_docs()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorUuid>().ManyAsync(a => a.Surname == guid && a.Age == 10);
    ...
    public async Task nested_properties_update_correctly()
    {
        ...
        await DBInstance.Instance().Update<BookUuid>()
    ...
    public async Task bulk_update_modifies_correct_documents()
    {
        ...
        var bulk = DBInstance.Instance().Update<BookUuid>();
    ...
    public async Task update_with_aggregation_pipeline_works()
    {
        ...
        var fullname = (await DBInstance.Instance().Find<AuthorUuid>().OneAsync(author.ID))?.FullName;
    ...
    public async Task update_with_template_match()
    {
        ...
        var fullname = (await DBInstance.Instance().Find<AuthorUuid>()
                         .OneAsync(author.ID))?
                         .FullName;
    ...
    public async Task update_with_modifywith_works()
    {
        ...
        await DBInstance.Instance().Update<FlowerUuid>()
            .MatchID(flower.Id)
            .ModifyWith(flower)
            .ExecuteAsync();

        var res = await DBInstance.Instance().Find<FlowerUuid>().OneAsync(flower.Id);
    ...
    public async Task bulk_update_with_modifywith()
    {
        ...
        var bulkUpdate = DBInstance.Instance().Update<BookUuid>();
