...
[TestClass]
public class DefaultDatabaseChangingInt64
{
    [TestMethod]
    ...
    public async Task returns_correct_database()
    {
        ...
        var bookDb = DBInstance.Instance().Database<BookInt64>();
    ...
    public async Task do_not_change_default_database_when_the_same()
    {
        ...
        var defaultDb = DBInstance.Instance().Database();
        var defaultDbName = DBInstance.Instance().DatabaseName<AuthorInt64>();
