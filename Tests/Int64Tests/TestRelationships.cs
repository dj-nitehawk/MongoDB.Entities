...
[TestClass]
public class RelationshipsInt64
{
    [TestMethod]
    public async Task setting_one_to_one_reference_returns_correct_Int64()
    {
        var book = new BookInt64 { Title = "book" };
        var author = new AuthorInt64 { Name = "sotorrce" };
    ...
    [TestMethod]
    public async Task setting_one_to_one_reference_with_implicit_operator_by_string_id_returns_correct_Int64()
    {
        var book = new BookInt64 { Title = "book" };
        var author = new AuthorInt64 { Name = "sotorrce" };
        await author.SaveAsync();
    ...
    [TestMethod]
    public async Task setting_one_to_one_reference_with_implicit_operator_by_Int64_returns_correct_Int64()
    {
        var book = new BookInt64 { Title = "book" };
        var author = new AuthorInt64 { Name = "soorfioberce" };
        await author.SaveAsync();
        book.MainAuthor = author.ToReference();
        await book.SaveAsync();
        var res = await (await book.Queryable()
    ...
    [TestMethod]
    public async Task one_to_one_to_Int64_with_lambda_projection()
    {
        var book = new BookInt64 { Title = "book" };
        var author = new AuthorInt64 { Name = "ototoewlp" };
        await author.SaveAsync();
        book.MainAuthor = author.ToReference();
        await book.SaveAsync();
        var res = await (await book.Queryable()
    ...
    [TestMethod]
    public async Task one_to_one_to_Int64_with_mongo_projection()
    {
        var book = new BookInt64 { Title = "book" };
        var author = new AuthorInt64 { Name = "ototoewmp" };
        await author.SaveAsync();
        book.MainAuthor = author.ToReference();
        await book.SaveAsync();
        var res = await (await book.Queryable()
    ...
    public async Task adding_one2many_references_returns_correct_entities_queryable()
    {
        ...
        var book1 = new BookInt64 { Title = "aotmrrceb1" };
        var book2 = new BookInt64 { Title = "aotmrrceb2" };
    ...
    {
        var author = new AuthorInt64 { Name = "author" };
        var book1 = new BookInt64 { Title = "aotmrrcebf1" };
        var book2 = new BookInt64 { Title = "aotmrrcebf2" };
        await book1.SaveAsync(); await book2.SaveAsync();
        await author.SaveAsync();
        await author.Books.AddAsync(book1);
        await author.Books.AddAsync(book2);
    ...
    {
        var book = new BookInt64 { Title = "rotmrrceb" };
        await book.SaveAsync();
        var author1 = new AuthorInt64 { Name = "rotmrrcea1" }; await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "rotmrrcea2" }; await author2.SaveAsync();
        await book.GoodAuthors.AddAsync(author1);
        await book.GoodAuthors.AddAsync(author2);
        var remAuthor = await DB.Queryable<AuthorInt64>()
    ...
    public async Task collection_shortcut_of_many_returns_correct_children()
    {
        var book = new BookInt64 { Title = "book" };
        await book.SaveAsync();
        var author1 = new AuthorInt64 { Name = "csomrcc1" }; await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "csomrcc1" }; await author2.SaveAsync();
        await book.GoodAuthors.AddAsync(author1);
        await book.GoodAuthors.AddAsync(author2);
    ...
    {
        var book = new BookInt64 { Title = "acsoupt" };
    ...
    {
        var book1 = new BookInt64 { Title = "mcc" }; await book1.SaveAsync();
        var gen1 = new GenreInt64 { Name = "ac2mrceg1" }; await gen1.SaveAsync();
        var gen2 = new GenreInt64 { Name = "ac2mrceg1" }; await gen2.SaveAsync();
        ...
        var book2 = new BookInt64 { Title = "mcc" }; await book2.SaveAsync();
    ...
    {
        var book1 = new BookInt64 { Title = "ac2mrceb1" }; await book1.SaveAsync();
        var book2 = new BookInt64 { Title = "ac2mrceb2" }; await book2.SaveAsync();
        ...
        await book1.Genres.AddAsync(gen2);
        await book1.Genres.AddAsync(gen1);
        Assert.AreEqual(2, DB.Queryable<BookInt64>().Where(b => b.ID == book1.ID).Single().Genres.ChildrenQueryable().Count());
    ...
    {
        var book1 = new BookInt64 { Title = "rm2mrceb1" }; await book1.SaveAsync();
        var book2 = new BookInt64 { Title = "rm2mrceb2" }; await book2.SaveAsync();

        var gen1 = new GenreInt64 { Name = "rm2mrceg1" }; await gen1.SaveAsync();
        var gen2 = new GenreInt64 { Name = "rm2mrceg1" }; await gen2.SaveAsync();
    ...
    //{
    //    var Int64 = Int64.NewInt64().ToString();

    //    var book = new BookInt64 { Title = "Planet Of The Apes " + Int64 };
    //    await book.SaveAsync();

    //    var genre = new GenreInt64 { Name = "SciFi " + Int64 };
    //    await genre.SaveAsync();

    //    var genre1 = new GenreInt64 { Name = "Thriller " + Int64 };
    ...
    //                    .ParentsQueryable<BookInt64>(genre.ID)
    //                    .ToListAsync();

    //    Assert.AreEqual(1, books.Count);
    //    Assert.AreEqual(book.Title, books.Single().Title);

    //    //var y = (await genre.Queryable().Where(g => g.Name.Contains(Int64)).ToListAsync()).Select(x => x.ID);
    //    //var x = book.Genres.ParentsQueryable<BookInt64>(y);
    //    //books = await x.ToListAsync();

    //    books = await book.Genres
    //            .ParentsQueryable<BookInt64>(genre.Queryable().Where(g => g.Name.Contains(Int64)))
    //            .ToListAsync();
    ...
    public async Task getting_parents_of_a_relationship_fluent_works()
    {
        ...
        var book = new BookInt64 { Title = "Planet Of The Apes " + guid };
        await book.SaveAsync();

        var genre = new GenreInt64 { Name = "SciFi " + guid };
        await genre.SaveAsync();

        var genre1 = new GenreInt64 { Name = "Thriller " + guid };
        await genre1.SaveAsync();
    ...
    {
        var author = new AuthorInt64 { Name = "author" }; await author.SaveAsync();
    ...
    {
        var a1 = new AuthorInt64 { Name = "author one" };
        var a2 = new AuthorInt64 { Name = "author two" };

        var b1 = new BookInt64 { Title = "book one" };
        var b2 = new BookInt64 { Title = "book two" };
