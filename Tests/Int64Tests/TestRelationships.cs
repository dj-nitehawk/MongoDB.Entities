...
public class RelationshipsInt64
{
    ...
    public async Task removing_a_one2many_ref_removes_correct_entities()
    {
        ...
        await book.SaveAsync();
        var author1 = new AuthorInt64 { Name = "rotmrrcea1" };
        await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "rotmrrcea2" };
        await author2.SaveAsync();
        await book.GoodAuthors.AddAsync(author1);
        await book.GoodAuthors.AddAsync(author2);
        var remAuthor = await DBInstance.Instance().Queryable<AuthorInt64>()
    ...
    public async Task collection_shortcut_of_many_returns_correct_children()
    {
        var book = new BookInt64 { Title = "book" };
        await book.SaveAsync();
        var author1 = new AuthorInt64 { Name = "csomrcc1" };
        await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "csomrcc1" };
        await author2.SaveAsync();
        await book.GoodAuthors.AddAsync(author1);
        await book.GoodAuthors.AddAsync(author2);
    ...
    {
        var book1 = new BookInt64 { Title = "mcc" };
        await book1.SaveAsync();
        var gen1 = new GenreInt64 { Name = "ac2mrceg1" };
        await gen1.SaveAsync();
        var gen2 = new GenreInt64 { Name = "ac2mrceg1" };
        ...
        var book2 = new BookInt64 { Title = "mcc" };
        await book2.SaveAsync();
    ...
    {
        var book1 = new BookInt64 { Title = "ac2mrceb1" };
        await book1.SaveAsync();
        var book2 = new BookInt64 { Title = "ac2mrceb2" };
        await book2.SaveAsync();
        ...
        await book1.Genres.AddAsync(gen2);
        await book1.Genres.AddAsync(gen1);
        Assert.AreEqual(2, DBInstance.Instance().Queryable<BookInt64>().Where(b => b.ID == book1.ID).Single().Genres.ChildrenQueryable().Count());
    ...
    {
        var book1 = new BookInt64 { Title = "rm2mrceb1" };
        await book1.SaveAsync();
        var book2 = new BookInt64 { Title = "rm2mrceb2" };
        await book2.SaveAsync();

        var gen1 = new GenreInt64 { Name = "rm2mrceg1" };
        await gen1.SaveAsync();
        var gen2 = new GenreInt64 { Name = "rm2mrceg1" };
        await gen2.SaveAsync();
    ...
    public async Task add_child_to_many_relationship_with_ID()
    {
        ...
        var b1 = new BookInt64 { Title = "book1" };
        await b1.SaveAsync();
        var b2 = new BookInt64 { Title = "book2" };
        await b2.SaveAsync();
