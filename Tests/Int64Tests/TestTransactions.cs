...
public class TransactionsInt64
{
    ...
    public async Task not_commiting_and_aborting_update_transaction_doesnt_modify_docs()
    {
        ...
        var author1 = new AuthorInt64 { Name = "uwtrcd1", Surname = guid };
        await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "uwtrcd2", Surname = guid };
        await author2.SaveAsync();
        var author3 = new AuthorInt64 { Name = "uwtrcd3", Surname = guid };
