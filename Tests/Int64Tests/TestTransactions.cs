...
public class TransactionsInt64
{
    ...
    public async Task not_commiting_and_aborting_update_transaction_doesnt_modify_docs()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorInt64>().OneAsync(author1.ID);
    ...
    public async Task delete_in_transaction_works()
    {
        ...
        Assert.AreEqual(null, await DBInstance.Instance().Find<BookInt64>().OneAsync(book1.ID));
    }
    ...
    public async Task bulk_save_entities_transaction_returns_correct_results()
    {
        ...
        var res = await DBInstance.Instance().Find<BookInt64>().ManyAsync(b => b.Title.Contains(guid));
        ...
        res = await DBInstance.Instance().Find<BookInt64>().ManyAsync(b => b.Title.Contains(guid));
