...
public class IndexesInt64
{
    ...
    {
        await DB.Default.DropCollectionAsync<AuthorInt64>();
        ...
        var res = DB.Default.FluentTextSearch<AuthorInt64>(Search.Full, author1.Surname).ToList();
        Assert.AreEqual(author1.Surname, res[0].Surname);

        var res2 = await DB.Default.Find<AuthorInt64>()
    ...
    public async Task full_text_search_with_wilcard_text_index_works()
    {
        ...
        var res = await DB.Default.FluentTextSearch<AuthorInt64>(Search.Full, author1.Surname).ToListAsync();
    ...
    {
        await DB.Default.Index<BookInt64>()
