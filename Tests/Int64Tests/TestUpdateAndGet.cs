...
public class UpdateAndGetInt64
{
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var author1 = new AuthorInt64 { Name = "bumcda1", Surname = "surname1", Age = 1 }; await author1.SaveAsync();
        var author2 = new AuthorInt64 { Name = "bumcda2", Surname = guid, Age = 1 }; await author2.SaveAsync();
        var author3 = new AuthorInt64 { Name = "bumcda3", Surname = guid, Age = 1 }; await author3.SaveAsync();
