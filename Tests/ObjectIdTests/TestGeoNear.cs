...
public class GeoNearObjectIdTest
{
    ...
    {
        await DBInstance.Instance().Index<PlaceObjectId>()
        ...
        var res = (await DBInstance.Instance().Find<PlaceObjectId>()
    ...
    public async Task geo_near_fluent_interface()
    {
        ...
        var qry = DBInstance.Instance().FluentGeoNear<PlaceObjectId>(
