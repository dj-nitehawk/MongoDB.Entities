...
public class RelationshipsObjectId
{
    ...
    public async Task one_to_one_to_ObjectId_with_lambda_projection()
    {
        ...
        var res = await (await book.Queryable()
                      .Where(b => b.ID == book.ID)
                      .SingleAsync())
                      .MainAuthor.ToEntityAsync(a => new AuthorObjectId { Name = a.Name });
        Assert.AreEqual(author.Name, res!.Name);
    ...
    public async Task removing_a_one2many_ref_removes_correct_entities()
    {
        ...
        await book.SaveAsync();
        var author1 = new AuthorObjectId { Name = "rotmrrcea1" }; await author1.SaveAsync();
        var author2 = new AuthorObjectId { Name = "rotmrrcea2" }; await author2.SaveAsync();
    ...
    public async Task collection_shortcut_of_many_returns_correct_children()
    {
        var book = new BookObjectId { Title = "book" };
        await book.SaveAsync();
        var author1 = new AuthorObjectId { Name = "csomrcc1" }; await author1.SaveAsync();
        var author2 = new AuthorObjectId { Name = "csomrcc1" }; await author2.SaveAsync();
        await book.GoodAuthors.AddAsync(author1);
        await book.GoodAuthors.AddAsync(author2);
    ...
    {
        var book1 = new BookObjectId { Title = "mcc" }; await book1.SaveAsync();
        var gen1 = new GenreObjectId { Name = "ac2mrceg1" }; await gen1.SaveAsync();
        var gen2 = new GenreObjectId { Name = "ac2mrceg1" }; await gen2.SaveAsync();
        ...
        var book2 = new BookObjectId { Title = "mcc" }; await book2.SaveAsync();
    ...
    {
        var book1 = new BookObjectId { Title = "ac2mrceb1" }; await book1.SaveAsync();
        var book2 = new BookObjectId { Title = "ac2mrceb2" }; await book2.SaveAsync();
    ...
    {
        var book1 = new BookObjectId { Title = "rm2mrceb1" }; await book1.SaveAsync();
        var book2 = new BookObjectId { Title = "rm2mrceb2" }; await book2.SaveAsync();

        var gen1 = new GenreObjectId { Name = "rm2mrceg1" }; await gen1.SaveAsync();
        var gen2 = new GenreObjectId { Name = "rm2mrceg1" }; await gen2.SaveAsync();
    ...
    {
        var author = new AuthorObjectId { Name = "author" }; await author.SaveAsync();

        var b1 = new BookObjectId { Title = "book1" }; await b1.SaveAsync();
        var b2 = new BookObjectId { Title = "book2" }; await b2.SaveAsync();
