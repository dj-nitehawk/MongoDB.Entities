...
public class SavingObjectId
{
    ...
    public async Task created_on_property_works()
    {
        ...
        var res = (await DBInstance.Instance().Find<AuthorObjectId, DateTime>()
    ...
    public async Task save_partially_single_include()
    {
        ...
        var res = await DBInstance.Instance().Find<BookObjectId>().MatchID(book.ID).ExecuteSingleAsync();
        ...
        res = await DBInstance.Instance().Find<BookObjectId>().MatchID(res.ID).ExecuteSingleAsync();
    ...
    public async Task save_partially_batch_include()
    {
        ...
        var res = await DBInstance.Instance().Find<BookObjectId>()
    ...
    public async Task save_preserving_upsert()
    {
        ...
        book = await DBInstance.Instance().Find<BookObjectId>().OneAsync(book.ID);
    ...
    public async Task save_preserving_inverse_attribute()
    {
        ...
        var res = await DBInstance.Instance().Find<BookObjectId>().OneAsync(book.ID);
    ...
    public async Task save_preserving_attribute()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorObjectId>().OneAsync(author.ID);
    ...
    public async Task find_by_lambda_returns_correct_documents()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorObjectId>().ManyAsync(a => a.Name == guid);
    ...
    public async Task find_by_id_returns_correct_document()
    {
        ...
        var res1 = await DBInstance.Instance().Find<BookObjectId>().OneAsync(ObjectId.GenerateNewId());
        var res2 = await DBInstance.Instance().Find<BookObjectId>().OneAsync(book2.ID);
    ...
    public async Task find_by_filter_basic_returns_correct_documents()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorObjectId>().ManyAsync(f => f.Eq(a => a.Name, guid));
    ...
    public async Task find_by_multiple_match_methods()
    {
        ...
        var res = await DBInstance.Instance().Find<AuthorObjectId>()
                          .Match(a => a.Age > 10)
    ...
    public async Task find_with_projection_to_custom_type_works()
    {
        ...
        var res = (await DBInstance.Instance().Find<AuthorObjectId, Test>()
                           .Match(f => f.Where(a => a.Surname == guid) & f.Gt(a => a.Age, 10))
                           .Sort(a => a.Age, Order.Descending)
                           .Sort(a => a.Name, Order.Descending)
                           .Skip(1)
    ...
    public async Task find_with_aggregation_pipeline_returns_correct_docs()
    {
        ...
        var res = await DBInstance.Instance().Fluent<AuthorObjectId>()
    ...
    public async Task find_with_include_required_props()
    {
        ...
        var res = await DBInstance.Instance().Find<ReviewObjectId>()
                          .MatchID(review.Id)
    ...
    public async Task update_and_get_with_include_required_props()
    {
        ...
        var res = await DBInstance.Instance().UpdateAndGet<ReviewObjectId>()
                          .MatchID(review.Id)
    ...
    public async Task decimal_properties_work_correctly()
    {
        ...
        var res = DBInstance.Instance().Queryable<BookObjectId>()
    ...
    public async Task custom_id_used_in_a_relationship()
    {
        ...
        var cus = await DBInstance.Instance().Queryable<BookObjectId>()
