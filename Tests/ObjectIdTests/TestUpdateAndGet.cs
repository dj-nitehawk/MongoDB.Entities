...
public class UpdateAndGetObjectId
{
    ...
    public async Task updating_modifies_correct_documents()
    {
        ...
        var res = await DBInstance.Instance().UpdateAndGet<AuthorObjectId, string>()
    ...
    {
        var guid = Guid.NewGuid().ToString();
        var author1 = new AuthorObjectId { Name = "bumcda1", Surname = "surname1", Age = 1 };
        await author1.SaveAsync();
        var author2 = new AuthorObjectId { Name = "bumcda2", Surname = guid, Age = 1 };
        await author2.SaveAsync();
        var author3 = new AuthorObjectId { Name = "bumcda3", Surname = guid, Age = 1 };
        await author3.SaveAsync();

        var res = await DBInstance.Instance().UpdateAndGet<AuthorObjectId>()
                          .Match(a => a.Surname == guid)
    ...
    public async Task update_with_array_filters_using_templates_work()
    {
        ...
        var res = await DBInstance.Instance().UpdateAndGet<BookObjectId>()
