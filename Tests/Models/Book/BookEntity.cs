...
public class BookEntity : Book
{
  ...
  public Many<AuthorEntity, BookEntity> GoodAuthors { get; set; }
  public Many<AuthorEntity, BookEntity> BadAuthors { get; set; }

  [OwnerSide]
  public Many<GenreEntity, BookEntity> Genres { get; set; }
