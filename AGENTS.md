...
Read relevant OKF files before editing. Start with `.okf/index.md`, then overview, architecture, code-map, conventions as needed; add testing/workflows/dependencies/operations/gotchas for the task. OKF guides—it does not replace checking source, tests, or manifests for exact behavior.
