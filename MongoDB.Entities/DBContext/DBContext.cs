...
namespace MongoDB.Entities
{
    ...
    public partial class DBContext
    {
        ...
        /// </summary>
        /// <param name="multiTenancyMode">Set this to true when calling this constructor</param>
        ...
        public DBContext(bool multiTenancyMode, string tenantPrefix, string dbName, string host = "127.0.0.1", int port = 27017, ModifiedBy modifiedBy = null)
        {
            if (!multiTenancyMode)
        ...
        /// You can even inherit from the ModifiedBy class and add your own properties to it. 
        /// Only one ModifiedBy property is allowed on a single entity type.</param>
        public DBContext(bool multiTenancyMode, string tenantPrefix, string dbName, MongoClientSettings settings, ModifiedBy modifiedBy = null)
        {
            if (!multiTenancyMode)
                throw new ArgumentException("multiTenancyMode should be set to True");
