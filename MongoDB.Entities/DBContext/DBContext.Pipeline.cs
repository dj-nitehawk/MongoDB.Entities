...
public partial class DBContext
{
    ...
    public Task<IAsyncCursor<TResult>> PipelineCursorAsync<T, TResult>(Template<T, TResult> template,
        ...
        => _db.PipelineCursorAsync(MergeGlobalFilter(template, ignoreGlobalFilters), options, Session, cancellation);
    ...
    public Task<List<TResult>> PipelineAsync<T, TResult>(Template<T, TResult> template,
                                                         ...
                                                         CancellationToken cancellation = default,
                                                         bool ignoreGlobalFilters = false) where T : IEntity
        => _db.PipelineAsync(MergeGlobalFilter(template, ignoreGlobalFilters), options, Session, cancellation);
    ...
    public Task<TResult> PipelineSingleAsync<T, TResult>(Template<T, TResult> template,
                                                         ...
                                                         CancellationToken cancellation = default,
                                                         bool ignoreGlobalFilters = false) where T : IEntity
        => _db.PipelineSingleAsync(MergeGlobalFilter(template, ignoreGlobalFilters), options, Session, cancellation);
    ...
    public Task<TResult> PipelineFirstAsync<T, TResult>(Template<T, TResult> template,
                                                        ...
                                                        CancellationToken cancellation = default,
                                                        bool ignoreGlobalFilters = false) where T : IEntity
        => _db.PipelineFirstAsync(MergeGlobalFilter(template, ignoreGlobalFilters), options, Session, cancellation);
