...
public partial class DBContext
{
    ...
    {
        var cmd = new Update<T>(Session, _globalFilters, OnBeforeUpdate<T>(), _dbInstance);
    ...
    {
        var cmd = new UpdateAndGet<T, TProjection>(Session, _globalFilters, OnBeforeUpdate<T>(), _dbInstance);
