...
namespace MongoDB.Entities
{
    public partial class DBContext
    {
        ...
        public PagedSearch<T> PagedSearch<T>(string? collectionName = null, IMongoCollection<T>? collection = null) where T : IEntity
        {
        ...
        public PagedSearch<T, TProjection> PagedSearch<T, TProjection>(string? collectionName = null, IMongoCollection<T>? collection = null) where T : IEntity
        {
