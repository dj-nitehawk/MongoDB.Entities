...
namespace MongoDB.Entities
{
    public static partial class DB
    {
        ...
        /// <param name="DistanceField"> string of the field name in dot notation, lowercase property
        ...
        /// <param name="IndexKey"> string of the field name in dot notation, lowercase property
        /// <param name="options">The options for the aggregation. This is not required.</param>
        /// <param name="session">An optional session if using within a transaction</param>
        public static IAggregateFluent<T> FluentGeoNear<T>(Coordinates2D NearCoordinates, string DistanceField = null, bool Spherical = true, double? MaxDistance = null, double? MinDistance = null, int? Limit = null, BsonDocument Query = null, double? DistanceMultiplier = null, string IncludeLocations = null, string IndexKey = null, AggregateOptions options = null, IClientSessionHandle session = null) where T : IEntity
        {
