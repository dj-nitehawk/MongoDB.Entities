...
public abstract class FilterQueryBase<T, TId, TSelf>
    where TId : IComparable<TId>, IEquatable<TId>
    where T : IEntity<TId>
    where TSelf : FilterQueryBase<T, TId, TSelf>

{
    ...
    internal FilterQueryBase(FilterQueryBase<T, TId, TSelf> other) : this(globalFilters: other._globalFilters)
    {
