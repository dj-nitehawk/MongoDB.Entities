...
namespace MongoDB.Entities
{
    ...
    public class One<T> where T : IEntity
    {
        ...
        //public Task<T> ToEntityAsync(IClientSessionHandle session = null, CancellationToken cancellation = default, string tenantPrefix = null)
        //{
        ...
        //public async Task<T> ToEntityAsync(Expression<Func<T, T>> projection, IClientSessionHandle session = null, CancellationToken cancellation = default, string tenantPrefix = null)
        //{
        ...
        ///// <param name="tenantPrefix">Optional tenant prefix if using multi-tenancy</param>
        ///// <returns>A Task containing the actual projected entity</returns>
        //public async Task<T> ToEntityAsync(Func<ProjectionDefinitionBuilder<T>, ProjectionDefinition<T, T>> projection, IClientSessionHandle session = null, CancellationToken cancellation = default, string tenantPrefix = null)
        //{
        //    return (await new Find<T>(session, null, tenantPrefix)
        //                .Match(ID)
        //                .Project(projection)
