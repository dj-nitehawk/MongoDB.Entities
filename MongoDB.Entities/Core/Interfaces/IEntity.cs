...
/// 0, Guid.Empty, etc.), a new ID is generated via the IIdGenerator resolved for the ID property: the generator set
/// on the entity's BsonClassMap (cm.IdMemberMap.SetIdGenerator()), or one registered for the ID's CLR type with
