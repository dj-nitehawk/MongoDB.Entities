...
{
    private static readonly StringSerializer _strSerializer = new();
    ...
    public override void Serialize(BsonSerializationContext ctx, BsonSerializationArgs args, FuzzyString? fString)
    {
        ...
        else
        {
            ...
            ctx.Writer.WriteString(nameof(FuzzyString.Value), fString.Value);
    ...
    public override FuzzyString? Deserialize(BsonDeserializationContext ctx, BsonDeserializationArgs args)
    {
        ...
        switch (bsonType)
        {
            case BsonType.Document:
                ...
                {
                    if (ctx.Reader.ReadName() == nameof(FuzzyString.Value))
    ...
    public bool TryGetMemberSerializationInfo(string memberName, out BsonSerializationInfo? serializationInfo)
    {
        ...
        {
            case "Value":
                serializationInfo = new BsonSerializationInfo("Value", _strSerializer, typeof(string));
                return true;
            default:
